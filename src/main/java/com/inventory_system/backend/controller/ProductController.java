...
public class ProductController {
    ...
    @GetMapping("/exist")
    public StandardResponse getProductsExistByInput(@RequestParam(value = "input") String input) throws Exception {
        return StandardResponse.createResponse(productService.findAllExisting(input), null);
    }
